    ...
    <div className="space-y-10">
        ...
        <div className="flex items-center gap-3">
          <button
            ...
            className={`rounded-full px-5 py-2 text-sm font-semibold transition ${
              tab === "vacaciones"
                ? "bg-teal-500 text-white shadow-lg shadow-teal-200/70"
                : "border border-teal-300 text-teal-600"
            }`}
          >
            Vacaciones
          </button>
      ...
      <div className="grid gap-8 lg:grid-cols-[260px_1fr]">
        <aside className="space-y-6">
          ...
          <div className="rounded-2xl border border-[color:var(--card-border)] bg-[color:var(--card)] p-5 shadow-[var(--shadow-soft)]">
            ...
            <div className="mt-4 space-y-3 text-sm text-[color:var(--text-secondary)]">
              <div className="flex items-center justify-between">
                ...
                <span className="font-semibold">{vacacionesCount}</span>
              </div>
              <div className="flex items-center justify-between">
                <span>Ausencias</span>
                <span className="font-semibold">{ausenciasCount}</span>
              </div>
              <div className="flex items-center justify-between">
            ...
            <>
              <div className="flex flex-wrap items-center justify-between gap-4">
                ...
                <div className="flex items-center gap-2 text-sm text-[color:var(--text-muted)]">
                  ...
                  <span className="min-w-[140px] text-center font-medium capitalize text-[color:var(--text-secondary)]">
                    {monthLabel}
                  </span>
                  <button
                    type="button"
              ...
              <div className="mt-6 grid grid-cols-7 gap-2 text-xs text-[color:var(--text-muted)]">
                {weekDays.map((day) => (
